            ...
            <div className="flex flex-col gap-1 max-w-xl w-100 px-4 bg-gray-800 rounded-lg py-4">
                ...
                <div className={`flex rounded-full bg-gray-600 ${player.host ? 'justify-between' : 'justify-center'}`}>

                    {
                        !loading && player.host && (
                            <button
                                className="bg-gray-700 rounded-full w-8 h-8 text-white cursor-pointer hover:bg-gray-400"
                ...
                <div className={`flex rounded-full bg-gray-600 ${player.host ? 'justify-between' : 'justify-center'}`}>
                    ...
                    }
                    {
                        !loading && player.host && (
                            <button
                                className="bg-gray-700 rounded-full w-8 h-8 text-white cursor-pointer hover:bg-gray-400 cursor-pointer"
                                onClick={(e) => {
                                    e.preventDefault();
                                    let n = gamesettings.GAME_TYPES.indexOf(gamesettings.GAME_MODE)
